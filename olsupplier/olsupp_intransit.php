...
$qrtyh=mysql_query("select billno from ol_bills where supp_id = '$uname' and ord_stat = 2 ");
...
<table width="95%" border="0" align="center" cellpadding="4" cellspacing="0">
  ...
  <tr>
    ...
    <table width="99%" border="1" align="center" cellpadding="4" cellspacing="0" style="border-collapse:collapse;">
	  ...
	  $slno = 1;
$qrtyh=mysql_query("select billno,shopid,prodid,prodqty,memid,bill_address,bill_date from ol_bills where supp_id = '$uname' and ord_stat = 2 ");
while($qraysjh=mysql_fetch_array($qrtyh))
{
...
?>
        <tr>
          ...
          <td align="left" valign="top"><div class="okdiv">Intransit</div></td>
        </tr>
      <?php $slno++;}  ?>
    </table>
    ...
    <?php } else { ?>    
    <div class="okdiv"><br />
      There are no  Orders Intransit<br />
      <br />
</div>
  <?php } ?>
  <tr>
