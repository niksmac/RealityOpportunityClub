...
if(isset($_GET['adm']))
{
	...
	session_start();
	$_SESSION['osuplogin']=1;
	$_SESSION['olsupplogin']=$_GET['u'];
...
{
	$qry=mysql_query("select suppl_id from olsupplier where suppl_id='$uname' and passwd='$pwd'");
	$fary=mysql_num_rows($qry);
	if($fary==1)
		{
			$_SESSION['osuplogin']=1;
			$_SESSION['olsupplogin']=$uname;
			header('Location:'."home.php");
		}
	else
		{
			$_SESSION['osuplogin']=0;
