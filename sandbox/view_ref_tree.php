...
<title>Refreeal Tree</title>
<script type="text/javascript" src="../users/js/jquery-1.2.2.pack.js"></script>
<script type="text/javascript" src="../users/js/ajaxtooltip.js"> </script>
...
<form id="form1" name="form1" method="get" action="">
  <input name="mid" type="text" id="mid" value="ROC ID" onclick="this.value=''" />
...
//		$jsdfj=mysql_query("select RefID from members where MemberID = '10001' ");
//		while($sdfsdfa=mysql_fetch_array($jsdfj))
//		{
//			$mmbr_id=$sdfsdfa['RefID'];
			...
			{
			$mmbr_idtop = $_GET['mid'];
			if (isValid($mmbr_idtop)) {
			echo $mmbr_idtop.'</br></br>';
			showMyChild($mmbr_idtop); } 
			}
			else {	
		...
		function showLink($myidd,$cnt)
		{
			...
			$mylink = $spaces.'<a href="view_ref_tree.php?mid='.$myidd.'" title="ajax:getdetails.php?id='.$myidd.'&ll='.$cnt.'" class="'.$class.'">'.$myidd.'</a><br>';			
			echo  $mylink;
