...
if ($Gender == "Male")
$myvar = "<a href='$mylink?id=$newidm&mem' title='ajax:getdetails.php?id=$newid'><img src='../users/img/maleuser.jpg'  width='48'border='0' /></a>";
else if($Gender == "Female")
$myvar = "<a href='$mylink?id=$newidm&mem' title='ajax:getdetails.php?id=$newid'><img src='../users/img/femaleuser.jpg'  width='48' border='0' /></a>";
else if($Gender == "")
$myvar = "<a href='$mylink?id=$newidm&mem' title='ajax:getdetails.php?id=$newid'><img src='../users/img/maleuser.jpg'  width='48' border='0' /></a>";
}
else 
$myvar = "<img src='../users/img/green-fade.JPG' width='48' border='0' />";
