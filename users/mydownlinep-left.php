<table width="95%" border="1" align="center" cellpadding="5" cellspacing="0" style="background-color:White;border-color:Green;border-width:1px;border-collapse:collapse; margin-bottom:100px;">
  <tr>
    <td colspan="7" align="center" valign="middle" bgcolor="#DEF4DD" ><h2><span class="headorngsml">LEFT  PRIMARY DOWNLINE</span></h2></td>
  </tr>
  <tr>
    <td width="19" align="left" valign="middle" bgcolor="#DEF4DD" ><h4><u><strong>No</strong></u></h4></td>
    <td width="47" align="left" valign="middle" bgcolor="#DEF4DD" ><h4><u><strong>ROC ID</strong></u></h4></td>
    <td width="68" align="left" valign="middle" bgcolor="#DEF4DD" ><h4><u><strong>Primary ID</strong></u></h4></td>
    <td width="35" align="left" valign="middle" bgcolor="#DEF4DD" ><h4><u>Level</u></h4></td>
    <td width="228" align="left" valign="middle" bgcolor="#DEF4DD" ><h4><u><strong>Name</strong></u></h4></td>
...
$qwerrtty=mysql_query("select primaryid from primarytree where memid='$uname' ");
...
$qwerrtty=mysql_query("select leftid from primarytree where primaryid='$primaryid' ");
while($husibc=mysql_fetch_array($qwerrtty))
{ 
$rightid=$husibc['leftid'];
}
