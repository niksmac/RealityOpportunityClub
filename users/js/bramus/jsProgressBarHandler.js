  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: 'img/bramus/percentImage.png',			// boxImage : image around the progress bar
			barImage	: 'img/bramus/percentImage_back.png',	// Image to use in the progressbar. Can be an array of images too.
			 ...
			 */
				_setBgPosition		: function(percentage) {
					...
					// Adjust the alt & title of the image
						$(this.id + "_percentImage").alt 						= percentage + " Days";
						$(this.id + "_percentImage").title 						= percentage + " Days";
						
					// Update the text
						if (this.options.showText == true) {
							$(this.id + "_percentText").update(" " + percentage + " Days");
						}
