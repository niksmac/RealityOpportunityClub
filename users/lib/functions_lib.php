...
if ($Gender == "Male")
$myvar = "<a href='$mylink?id=$newid' title='ajax:getdetails.php?id=$newid'><img src='img/maleuser.jpg'  width='48'border='0' /></a>";
else if($Gender == "Female")
$myvar = "<a href='$mylink?id=$newid' title='ajax:getdetails.php?id=$newid'><img src='img/femaleuser.jpg'  width='48' border='0' /></a>";
else if($Gender == "")
$myvar = "<a href='$mylink?id=$newid' title='ajax:getdetails.php?id=$newid'><img src='img/maleuser.jpg'  width='48' border='0' /></a>";
}
else 
