...
$dfdgfgs=mysql_query("select totrefbv  from accstmntnikamts  where memid='$rocuname'  ");
...
$dfdgfgs=mysql_query("select SelfBV,AsideBV,BsideBV,SelfPI, AsidePI, BsidePI, TotalBVTillLastClosing, REFBV, percetagePossition  from pilastclosing where MemberID='$rocuname' and CloseNo = '$close_no'  ");
while($sdfsxccdfa=mysql_fetch_array($dfdgfgs))
{
...
<table width="80%" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#666666" style="margin-top:40px;" >
  <tr>
    <td align="center" valign="middle"><table width="99%" border="0" align="center" cellpadding="3" cellspacing="0" style="border-collapse:collapse;">
      ...
      <tr>
        <td width="598" align="left" valign="top"><table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
            <tr>
        ...
        <td width="599" align="left" valign="top"><table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
            <tr>
            ...
            <tr>
              <td align="left" valign="middle">ROC ID : <?php echo $rocuname; ?><br />
                Percentage Position : <?php echo $percetagePossition; ?></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td colspan="2" align="left" valign="top"><table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
            ...
            <tr>
              <td align="left" valign="middle"><?php echo $uname; ?></td>
            ...
            <tr>
              ...
              <td align="left" valign="middle"><?php echo $AsideBV; ?></td>
              <td align="left" valign="middle"><?php echo $AsideBV; ?></td>
            </tr>
            <tr>
              <td align="left" valign="middle"><?php echo showName($RChildID); ?></td>
              <td align="left" valign="middle">&nbsp;</td>
              <td align="left" valign="middle"><?php echo $BsideBV; ?></td>
              <td align="left" valign="middle"><?php echo $BsideBV; ?></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td colspan="2" align="left" valign="top"><table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
            ...
            <tr>
              ...
              <td width="15%" align="right" valign="middle"><?php echo $ref_income; ?></td>
            ...
            <tr>
              ...
              <td align="right" valign="middle"><?php echo $TotalBVTillLastClosing; ?></td>
              <td align="left" valign="middle" bordercolor="#CCCCCC" bgcolor="#CCCCCC">&nbsp;</td>
            ...
            <tr>
              ...
              <td align="right" valign="middle"><?php echo $REFBV; ?></td>
  ...
  ?>
      ...
      <tr>
        <td colspan="2" align="left" valign="top"><table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
            <tr>
              <td align="left" valign="middle">Amount in Words <strong><?php echo ucwords(numberToWords($netpaybl)); ?></strong></td>
            </tr>
        </table></td>
      </tr>
      <tr>
