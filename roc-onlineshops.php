...
<script type="text/javascript">
  ...
  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="0">
    <tr>
      <td width="15%" align="left" valign="top"><div class="tableouter"><form action="roc-onlineshops.php" method="post" name="shopsearch" id="shopsearch">
  
    <table width="95%" border="0" align="center" cellpadding="2" cellspacing="0">
      <tr>
        <td><h2>Search On-Line Shops</h2></td>
      </tr>
      <tr>
...
<table width="200" border="0" cellspacing="0" cellpadding="2">
      ...
      <td width="85%" align="left" valign="top"><table width="99%" border="1" align="center" cellpadding="5" cellspacing="0" bordercolor="#557B24" style="border-collapse:collapse; margin-bottom:100px;">
        ...
        <?php 
$tyu=1;
$qry=mysql_query("select storename,address,phone,location  from olshops where  shpstat=1 ");
...
function getTitle()
{
return "On-Line Shops | Reality Opportunity Club";
}
function showMeta()
{
$qry=mysql_query("select storename  from olshops where id <> 9 ");
while($qrys=mysql_fetch_array($qry))
{
